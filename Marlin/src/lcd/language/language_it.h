...
#define MSG_LCD_SOFT_ENDSTOPS               _UxGT("Finecorsa legg.")
...
#define MSG_AUTOSTART                       _UxGT("Avvio automatico")
...
#define MSG_IDEX_SAVE_OFFSETS               _UxGT("Memorizza offset")
...
#define MSG_OUTAGE_RECOVERY                 _UxGT("Ripresa da interr. corr.")
...
#define MSG_NO_MOVE                         _UxGT("Nessunmovimento")
#define MSG_KILLED                          _UxGT("ANNULLATO. ")
...
#define MSG_INIT_SDCARD                     _UxGT("Iniz. scheda SD")
#define MSG_CHANGE_SDCARD                   _UxGT("Cambia scheda SD")
...
//                                                  ...o fino a 2 linee su un display a 3 righe.
...
#else // LCD_HEIGHT < 4
  #define MSG_ADVANCED_PAUSE_WAITING_1      _UxGT("Premi per continuare")
  ...
  #define MSG_FILAMENT_CHANGE_CONT_PURGE_1  _UxGT("Premi per terminare")
